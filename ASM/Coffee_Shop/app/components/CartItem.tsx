...
interface CartItemProps {
  id: string;
  name: string;
  imagelink_square: string | number;
...
const CartItem: React.FC<CartItemProps> = ({
  ...
  const resolvedImage = () => {
    if (typeof imagelink_square === 'string') {
      return getLocalImage(imagelink_square);
    } else {
  ...
  if (prices.length > 1) {
    return (
      ...
      >
        <View style={styles.CartItemRow}>
          <Image source={resolvedImage()} style={styles.CartItemImage} />
    ...
    return (
      ...
      >
        <View>
          <Image source={resolvedImage()} style={styles.CartItemSingleImage} />
        </View>
        <View style={styles.CartItemSingleInfoContainer}>
          ...
          <View style={styles.CartItemSingleSizeValueContainer}>
            ...
            <Text style={styles.SizeCurrency}>
              ...
              <Text style={styles.SizePrice}> {singlePrice.price}</Text>
            </Text>
          </View>
          <View style={styles.CartItemSingleQuantityContainer}>
            <TouchableOpacity
              style={styles.CartItemIcon}
              onPress={() =>
                decrementCartItemQuantityHandler(id, singlePrice.size)
              }
            >
              <CustomIcon
                name="minus"
            ...
            <TouchableOpacity
              style={styles.CartItemIcon}
              onPress={() =>
                incrementCartItemQuantityHandler(id, singlePrice.size)
              }
            >
              <CustomIcon
                name="add"
